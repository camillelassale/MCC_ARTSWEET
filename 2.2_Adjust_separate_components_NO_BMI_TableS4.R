...
write.table(table3,file="./ANALYSIS/OUTPUT/supplPAnoBMI/num_aspar_noaspar.csv",sep=";")
dependent = "casom"
mccbreast %>%   finalfit(dependent, explanatory3, metrics=F) -> table4
write.table(table4,file="./ANALYSIS/OUTPUT/supplPAnoBMI/num_aspar_noaspar.csv",sep=";",append=T)
dependent = "casop"
mcc2 %>%   finalfit(dependent, explanatory3, metrics=F) -> table3
write.table(table3,file="./ANALYSIS/OUTPUT/supplPAnoBMI/num_aspar_noaspar.csv",sep=";",append=T)
dependent = "casoe"
mcc2 %>%   finalfit(dependent, explanatory3, metrics=F) -> table3
write.table(table3,file="./ANALYSIS/OUTPUT/supplPAnoBMI/num_aspar_noaspar.csv",sep=";",append=T)
dependent = "casol"
...
fitcolon<-glm(casoc~as.factor(aspar_cat3) + as.factor(noaspar_cat3)  +as.factor(FHcolon) + edad + as.factor(radio) + as.factor(sexo) + as.factor(educ) + as.factor(smk) +  as.factor(nightshift_) +
                t_ethanol + t_fiber + redmeat10 + kcal100 + sugar10 + METS10AÑOS_2TOTAL+ as.factor(ccaa),family="binomial",data=mcc2 )
...
write.table(try,file="./ANALYSIS/OUTPUT/supplPAnoBMI/aspar_noaspar.csv",sep=";")
...
fitbreast<-glm(casom~as.factor(aspar_cat3) + as.factor(noaspar_cat3)  +as.factor(FHbreast) + edad + as.factor(radio) + as.factor(educ) + as.factor(smk) + as.factor(nightshift_) +
                 t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL + as.factor(agefirst) + as.factor(menopausia) + as.factor(nulipara) + as.factor(ACO) +
...
try<-paste(round(table1[2:5,1],digits=2)," (",round(table1[2:5,2],digits=2),"-",round(table1[2:5,3],digits=2),", p=",round(table1[2:5,4],digits=3),")", sep="")
write.table(try,file="./ANALYSIS/OUTPUT/supplPAnoBMI/aspar_noaspar.csv",sep=";",append=T)
...
table1<-table1[2:3,1]
write.table(table1,file="./ANALYSIS/OUTPUT/supplPAnoBMI/pvalue_aspar_noaspar.csv",sep=";")
...
table1<-table1[2:3,1]
write.table(table1,file="./ANALYSIS/OUTPUT/supplPAnoBMI/pvalue_aspar_noaspar.csv",sep=";",append=T)
...
write.table(table4,file="./ANALYSIS/OUTPUT/supplPAnoBMI/num_aspar_noaspar_premenop.csv",sep=";")
fitbreast<-glm(casom~ as.factor(aspar_cat3) + as.factor(noaspar_cat3) +as.factor(FHbreast) + edad + as.factor(radio) + as.factor(educ) + as.factor(smk) + as.factor(nightshift_) +
                 t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL + as.factor(agefirst) + as.factor(nulipara) + as.factor(ACO) +
...
write.table(try,file="./ANALYSIS/OUTPUT/supplPAnoBMI/aspar_noaspar_premenop.csv",sep=";")
...
table1<-cbind(round(coef(summary(fitbreast))[,'Pr(>|z|)'],digits=3))
table1<-table1[2:3,1]
write.table(table1,file="./ANALYSIS/OUTPUT/supplPAnoBMI/pvalue_aspar_noaspar_premenop.csv",sep=";")

# Postmenop
postmenop %>%   finalfit(dependent, explanatory, metrics=F) -> table4
write.table(table4,file="./ANALYSIS/OUTPUT/supplPAnoBMI/num_aspar_noaspar_postmenop.csv",sep=";")
fitbreast<-glm(casom~ as.factor(aspar_cat3) + as.factor(noaspar_cat3) +as.factor(FHbreast) + edad + as.factor(radio) + as.factor(educ) + as.factor(smk) + as.factor(nightshift_) +
                 t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL + as.factor(agefirst) + as.factor(nulipara) + as.factor(ACO) +
...
table1<-cbind(round(exp(cbind(OR = coef(fitbreast), confint(fitbreast))),digits=2),round(coef(summary(fitbreast))[,'Pr(>|z|)'],digits=3))
try<-paste(round(table1[2:6,1],digits=2)," (",round(table1[2:6,2],digits=2),"-",round(table1[2:6,3],digits=2),", p=",round(table1[2:6,4],digits=3),")", sep="")
write.table(try,file="./ANALYSIS/OUTPUT/supplPAnoBMI/aspar_noaspar_postmenop.csv",sep=";")
...
table1<-cbind(round(coef(summary(fitbreast))[,'Pr(>|z|)'],digits=3))
table1<-table1[2:3,1]
write.table(table1,file="./ANALYSIS/OUTPUT/supplPAnoBMI/pvalue_aspar_noaspar_postmenop.csv",sep=";")
...
write.table(table3,file="./ANALYSIS/OUTPUT/supplPAnoBMI/numnodiab_aspar_noaspar.csv",sep=";")
dependent = "casom"
nodiabbreast %>%   finalfit(dependent, explanatory3, metrics=F) -> table4
write.table(table4,file="./ANALYSIS/OUTPUT/supplPAnoBMI/numnodiab_aspar_noaspar.csv",sep=";",append=T)
dependent = "casop"
nodiab %>%   finalfit(dependent, explanatory3, metrics=F) -> table3
write.table(table3,file="./ANALYSIS/OUTPUT/supplPAnoBMI/numnodiab_aspar_noaspar.csv",sep=";",append=T)
dependent = "casoe"
nodiab %>%   finalfit(dependent, explanatory3, metrics=F) -> table3
write.table(table3,file="./ANALYSIS/OUTPUT/supplPAnoBMI/numnodiab_aspar_noaspar.csv",sep=";",append=T)
dependent = "casol"
...
# Adjusted models
fitcolon<-glm(casoc~as.factor(aspar_cat3) + as.factor(noaspar_cat3)  +as.factor(FHcolon) + edad + as.factor(radio) + as.factor(sexo) + as.factor(educ) + as.factor(smk) +  as.factor(nightshift_) +
                t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL+ as.factor(ccaa),family="binomial",data=nodiab )
table1<-cbind(round(exp(cbind(OR = coef(fitcolon), confint(fitcolon))),digits=2),round(coef(summary(fitcolon))[,'Pr(>|z|)'],digits=3))
try<-paste(round(table1[2:5,1],digits=2)," (",round(table1[2:5,2],digits=2),"-",round(table1[2:5,3],digits=2),", p=",round(table1[2:5,4],digits=3),")", sep="")
write.table(try,file="./ANALYSIS/OUTPUT/supplPAnoBMI/nodiab_aspar_noaspar.csv",sep=";")
...
table1<-cbind(round(exp(cbind(OR = coef(fitbreast), confint(fitbreast))),digits=2),round(coef(summary(fitbreast))[,'Pr(>|z|)'],digits=3))
try<-paste(round(table1[2:5,1],digits=2)," (",round(table1[2:5,2],digits=2),"-",round(table1[2:5,3],digits=2),", p=",round(table1[2:5,4],digits=3),")", sep="")
write.table(try,file="./ANALYSIS/OUTPUT/supplPAnoBMI/nodiab_aspar_noaspar.csv",sep=";",append=T)
...
# the p-value for trend
#######################
nodiab$aspar_cat3<-as.numeric(nodiab$aspar_cat3)
nodiab$noaspar_cat3<-as.numeric(nodiab$noaspar_cat3)
fitcolon<-glm(casoc~aspar_cat3 + noaspar_cat3  +as.factor(FHcolon) + edad + as.factor(radio) + as.factor(sexo) + as.factor(educ) + as.factor(smk) +  as.factor(nightshift_) +
                t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL+ as.factor(ccaa),family="binomial",data=nodiab )
table1<-cbind(round(coef(summary(fitcolon))[,'Pr(>|z|)'],digits=3))
table1<-table1[2:3,1]
write.table(table1,file="./ANALYSIS/OUTPUT/supplPAnoBMI/nodiab_pvalue_aspar_noaspar.csv",sep=";")

fitbreast<-glm(casom~aspar_cat3 + noaspar_cat3   +as.factor(FHbreast) + edad + as.factor(radio) + as.factor(educ) + as.factor(smk) + as.factor(nightshift_) +
                 t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL + as.factor(agefirst) + as.factor(menopausia) + as.factor(nulipara) + as.factor(ACO) +
                 as.factor(ccaa),family="binomial",data=nodiab  )
table1<-cbind(round(coef(summary(fitbreast))[,'Pr(>|z|)'],digits=3))
table1<-table1[2:3,1]
write.table(table1,file="./ANALYSIS/OUTPUT/supplPAnoBMI/nodiab_pvalue_aspar_noaspar.csv",sep=";",append=T)

fitprostate<-glm(casop~aspar_cat3 + noaspar_cat3   +as.factor(FHprostate) + edad + as.factor(radio) 
...
fitstomach<-glm(casoe~aspar_cat3 + noaspar_cat3   + edad + as.factor(radio) + as.factor(sexo) + as.factor(educ) + as.factor(smk) + 
                  t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL + as.factor(ccaa),family="binomial",data=nodiab  )
summary(fitstomach)
table1<-cbind(round(coef(summary(fitstomach))[,'Pr(>|z|)'],digits=3))
table1<-table1[2:3,1]
...
fitcll<-glm(casol~aspar_cat3 + noaspar_cat3   + edad + as.factor(radio) + as.factor(sexo) + as.factor(educ) + as.factor(smk) + 
              t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL + as.factor(ccaa),family="binomial",data=nodiab  )
summary(fitcll)
table1<-cbind(round(coef(summary(fitcll))[,'Pr(>|z|)'],digits=3))
table1<-table1[2:3,1]
...
write.table(table3,file="./ANALYSIS/OUTPUT/supplPAnoBMI/numdiab_aspar_noaspar.csv",sep=";")
dependent = "casom"
diabbreast %>%   finalfit(dependent, explanatory3, metrics=F) -> table4
write.table(table4,file="./ANALYSIS/OUTPUT/supplPAnoBMI/numdiab_aspar_noaspar.csv",sep=";",append=T)
dependent = "casop"
diab %>%   finalfit(dependent, explanatory3, metrics=F) -> table3
write.table(table3,file="./ANALYSIS/OUTPUT/supplPAnoBMI/numdiab_aspar_noaspar.csv",sep=";",append=T)
dependent = "casoe"
diab %>%   finalfit(dependent, explanatory3, metrics=F) -> table3
write.table(table3,file="./ANALYSIS/OUTPUT/supplPAnoBMI/numdiab_aspar_noaspar.csv",sep=";",append=T)
dependent = "casol"
...
# Adjusted models
fitcolon<-glm(casoc~as.factor(aspar_cat3) + as.factor(noaspar_cat3)  +as.factor(FHcolon) + edad + as.factor(radio) + as.factor(sexo) + as.factor(educ) + as.factor(smk) +  as.factor(nightshift_) +
                t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL+ as.factor(ccaa),family="binomial",data=diab )
table1<-cbind(round(exp(cbind(OR = coef(fitcolon), confint(fitcolon))),digits=2),round(coef(summary(fitcolon))[,'Pr(>|z|)'],digits=3))
try<-paste(round(table1[2:5,1],digits=2)," (",round(table1[2:5,2],digits=2),"-",round(table1[2:5,3],digits=2),", p=",round(table1[2:5,4],digits=3),")", sep="")
write.table(try,file="./ANALYSIS/OUTPUT/supplPAnoBMI/diab_aspar_noaspar.csv",sep=";")
...
table1<-cbind(round(exp(cbind(OR = coef(fitbreast), confint(fitbreast))),digits=2),round(coef(summary(fitbreast))[,'Pr(>|z|)'],digits=3))
try<-paste(round(table1[2:5,1],digits=2)," (",round(table1[2:5,2],digits=2),"-",round(table1[2:5,3],digits=2),", p=",round(table1[2:5,4],digits=3),")", sep="")
write.table(try,file="./ANALYSIS/OUTPUT/supplPAnoBMI/diab_aspar_noaspar.csv",sep=";",append=T)
...
# the p-value for trend
#######################
diab$aspar_cat3<-as.numeric(diab$aspar_cat3)
diab$noaspar_cat3<-as.numeric(diab$noaspar_cat3)
fitcolon<-glm(casoc~aspar_cat3 + noaspar_cat3  +as.factor(FHcolon) + edad + as.factor(radio) + as.factor(sexo) + as.factor(educ) + as.factor(smk) +  as.factor(nightshift_) +
                t_ethanol + t_fiber + redmeat10  + kcal100 + sugar10 + METS10AÑOS_2TOTAL+ as.factor(ccaa),family="binomial",data=diab )
table1<-cbind(round(coef(summary(fitcolon))[,'Pr(>|z|)'],digits=3))
table1<-table1[2:3,1]
write.table(table1,file="./ANALYSIS/OUTPUT/supplPAnoBMI/diab_pvalue_aspar_noaspar.csv",sep=";")
...
table1<-cbind(round(coef(summary(fitbreast))[,'Pr(>|z|)'],digits=3))
table1<-table1[2:3,1]
write.table(table1,file="./ANALYSIS/OUTPUT/supplPAnoBMI/diab_pvalue_aspar_noaspar.csv",sep=";",append=T)
